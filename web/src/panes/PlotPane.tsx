        ...
        <div className="drawer-scroll">
          ...
          <section className="drawer-section">
            ...
            <div className="drawer-grid">
              ...
              <label className="span-2">What changes?<textarea rows={4} value={summary} onChange={(event) => setSummary(event.target.value)} placeholder="Recognition changes character-1’s objective." /></label>
            </div>
          </section>
          <section className="drawer-section">
