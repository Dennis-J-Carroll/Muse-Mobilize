  ...
  return <form className="scene-drawer" onSubmit={save}>
      ...
      <div className="scene-drawer-scroll">
        ...
        <section><h3>Story position</h3><div className="scene-form-grid">
          <label className="span-2">Scene title<input ref={titleRef} value={title} onChange={(event) => setTitle(event.target.value)} placeholder="Council summons character-1" /></label>
