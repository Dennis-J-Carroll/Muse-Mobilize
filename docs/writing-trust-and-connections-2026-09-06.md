...
Next story-integration work remains a separately approved `/mobilize` importer: provenance, document maturity, and competing-account schema before any KingsBlood import. KingsBlood at `/home/dennisjcarroll/Desktop/creative/KingsBlood` remains read-only. The prior preview proposes Dermelius Royer, Jandell, and The Load They Bear; do not treat that proposal as permission to import or rewrite them.
